...
import 'package:at_clinic/features/doctors_list/screen/select_time_screen.dart';
...
class SelectedDoctorScreen extends StatefulWidget {
  static const String routeName = "/selectedDoctorScreen";
  const SelectedDoctorScreen({Key? key}) : super(key: key);

  @override
  State<SelectedDoctorScreen> createState() => _SelectedDoctorScreenState();
}

class _SelectedDoctorScreenState extends State<SelectedDoctorScreen> {
  //height and width
  double height = 0.0;
  double width = 0.0;
      ...
      children: [
        InkWell(
          onTap: () =>  Navigator.of(context)
                .pushNamed(SelectTimeScreen.routeName),
          child: Container(
            ...
            child: Center(
              child: BuildText(
              text: StringConstants.selectYourTime,
              color: ColorName.colorWhite,
              family: FontFamily.poppinsSemiBold,
              fontSize: 10.0.medium15px(),
            ),
        ...
        BuildText(
          ...
          child: Center(
            child: BuildText(
            text: StringConstants.contactClinic,
            color: ColorName.colorPrimary,
            family: FontFamily.poppinsSemiBold,
            fontSize: 10.0.medium15px(),
          ),
